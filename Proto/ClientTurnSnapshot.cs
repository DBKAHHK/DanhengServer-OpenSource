...
namespace EggLink.DanhengServer.Proto {
    ...
    static ClientTurnSnapshotReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZXZlbnRfbGlzdBgFIAMoCzISLkFuaW1FdmVudFNuYXBzaG90EhMKC0pFSU5C",
            "TUxGQ0JQGAYgASgNQh6qAhtFZ2dMaW5rLkRhbmhlbmdTZXJ2ZXIuUHJvdG9i",
            "BnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.ClientTurnSnapshot), global::EggLink.DanhengServer.Proto.ClientTurnSnapshot.Parser, new[]{ "TurnCounter", "RandomCounter", "AnimEventCounter", "SnapshotList", "AnimEventList", "JEINBMLFCBP" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ClientTurnSnapshot(ClientTurnSnapshot other) : this() {
      ...
      jEINBMLFCBP_ = other.jEINBMLFCBP_;
    ...
    /// <summary>Field number for the "JEINBMLFCBP" field.</summary>
    public const int JEINBMLFCBPFieldNumber = 6;
    private uint jEINBMLFCBP_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint JEINBMLFCBP {
      get { return jEINBMLFCBP_; }
      set {
        jEINBMLFCBP_ = value;
      }
    }
    ...
    public bool Equals(ClientTurnSnapshot other) {
      ...
      if (JEINBMLFCBP != other.JEINBMLFCBP) return false;
    ...
    public override int GetHashCode() {
      ...
      if (JEINBMLFCBP != 0) hash ^= JEINBMLFCBP.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (JEINBMLFCBP != 0) {
        ...
        output.WriteUInt32(JEINBMLFCBP);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (JEINBMLFCBP != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(JEINBMLFCBP);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(ClientTurnSnapshot other) {
      ...
      if (other.JEINBMLFCBP != 0) {
        JEINBMLFCBP = other.JEINBMLFCBP;
      }
