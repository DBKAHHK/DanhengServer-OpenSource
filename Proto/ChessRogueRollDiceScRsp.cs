...
namespace EggLink.DanhengServer.Proto {
    ...
    static ChessRogueRollDiceScRspReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Y2VJbmZvLnByb3RvIm0KF0NoZXNzUm9ndWVSb2xsRGljZVNjUnNwEhMKC0RD",
            "SUhLTUZOSEJNGAcgASgNEg8KB3JldGNvZGUYCCABKA0SLAoPcm9ndWVfZGlj",
            "ZV9pbmZvGA4gASgLMhMuQ2hlc3NSb2d1ZURpY2VJbmZvQh6qAhtFZ2dMaW5r",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.ChessRogueRollDiceScRsp), global::EggLink.DanhengServer.Proto.ChessRogueRollDiceScRsp.Parser, new[]{ "DCIHKMFNHBM", "Retcode", "RogueDiceInfo" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ChessRogueRollDiceScRsp(ChessRogueRollDiceScRsp other) : this() {
      dCIHKMFNHBM_ = other.dCIHKMFNHBM_;
    ...
    /// <summary>Field number for the "DCIHKMFNHBM" field.</summary>
    public const int DCIHKMFNHBMFieldNumber = 7;
    private uint dCIHKMFNHBM_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint DCIHKMFNHBM {
      get { return dCIHKMFNHBM_; }
      set {
        dCIHKMFNHBM_ = value;
      }
    }
    ...
    public bool Equals(ChessRogueRollDiceScRsp other) {
      ...
      if (DCIHKMFNHBM != other.DCIHKMFNHBM) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (DCIHKMFNHBM != 0) hash ^= DCIHKMFNHBM.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (DCIHKMFNHBM != 0) {
        ...
        output.WriteUInt32(DCIHKMFNHBM);
      }
      if (Retcode != 0) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (DCIHKMFNHBM != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(DCIHKMFNHBM);
      }
      if (Retcode != 0) {
    ...
    public void MergeFrom(ChessRogueRollDiceScRsp other) {
      ...
      if (other.DCIHKMFNHBM != 0) {
        DCIHKMFNHBM = other.DCIHKMFNHBM;
      }
      if (other.Retcode != 0) {
