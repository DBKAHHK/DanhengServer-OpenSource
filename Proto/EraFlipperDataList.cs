...
namespace EggLink.DanhengServer.Proto {
    ...
    static EraFlipperDataListReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "X2xpc3QYBiADKAsyDy5FcmFGbGlwcGVyRGF0YUIeqgIbRWdnTGluay5EYW5o",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.EraFlipperDataList), global::EggLink.DanhengServer.Proto.EraFlipperDataList.Parser, new[]{ "EraFlipperDataList_" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public EraFlipperDataList(EraFlipperDataList other) : this() {
      eraFlipperDataList_ = other.eraFlipperDataList_.Clone();
    ...
    public const int EraFlipperDataList_FieldNumber = 6;
    private static readonly pb::FieldCodec<global::EggLink.DanhengServer.Proto.EraFlipperData> _repeated_eraFlipperDataList_codec
        = pb::FieldCodec.ForMessage(50, global::EggLink.DanhengServer.Proto.EraFlipperData.Parser);
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::EggLink.DanhengServer.Proto.EraFlipperData> EraFlipperDataList_ {
      get { return eraFlipperDataList_; }
    }
    ...
    public bool Equals(EraFlipperDataList other) {
      ...
      if(!eraFlipperDataList_.Equals(other.eraFlipperDataList_)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      hash ^= eraFlipperDataList_.GetHashCode();
    ...
    #else
      eraFlipperDataList_.WriteTo(output, _repeated_eraFlipperDataList_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      eraFlipperDataList_.WriteTo(ref output, _repeated_eraFlipperDataList_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      size += eraFlipperDataList_.CalculateSize(_repeated_eraFlipperDataList_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(EraFlipperDataList other) {
      ...
      eraFlipperDataList_.Add(other.eraFlipperDataList_);
