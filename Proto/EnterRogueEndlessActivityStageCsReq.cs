...
namespace EggLink.DanhengServer.Proto {
    ...
    static EnterRogueEndlessActivityStageCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "QWN0aXZpdHlTdGFnZUNzUmVxEigKC2F2YXRhcl9saXN0GAMgAygLMhMuUm9n",
            "dWVFbmRsZXNzQXZhdGFyEhMKC0tDSUVDUEVLTEFCGAQgASgNQh6qAhtFZ2dM",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.EnterRogueEndlessActivityStageCsReq), global::EggLink.DanhengServer.Proto.EnterRogueEndlessActivityStageCsReq.Parser, new[]{ "AvatarList", "KCIECPEKLAB" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public EnterRogueEndlessActivityStageCsReq(EnterRogueEndlessActivityStageCsReq other) : this() {
      ...
      kCIECPEKLAB_ = other.kCIECPEKLAB_;
    ...
    private static readonly pb::FieldCodec<global::EggLink.DanhengServer.Proto.RogueEndlessAvatar> _repeated_avatarList_codec
        = pb::FieldCodec.ForMessage(26, global::EggLink.DanhengServer.Proto.RogueEndlessAvatar.Parser);
    ...
    /// <summary>Field number for the "KCIECPEKLAB" field.</summary>
    public const int KCIECPEKLABFieldNumber = 4;
    private uint kCIECPEKLAB_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint KCIECPEKLAB {
      get { return kCIECPEKLAB_; }
      set {
        kCIECPEKLAB_ = value;
      }
    }
    ...
    public bool Equals(EnterRogueEndlessActivityStageCsReq other) {
      ...
      if (KCIECPEKLAB != other.KCIECPEKLAB) return false;
    ...
    public override int GetHashCode() {
      ...
      if (KCIECPEKLAB != 0) hash ^= KCIECPEKLAB.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (KCIECPEKLAB != 0) {
        ...
        output.WriteUInt32(KCIECPEKLAB);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (KCIECPEKLAB != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(KCIECPEKLAB);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(EnterRogueEndlessActivityStageCsReq other) {
      ...
      if (other.KCIECPEKLAB != 0) {
        KCIECPEKLAB = other.KCIECPEKLAB;
      }
