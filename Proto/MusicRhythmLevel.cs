...
namespace EggLink.DanhengServer.Proto {
  ...
  public static partial class MusicRhythmLevelReflection {
    ...
    static MusicRhythmLevelReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChZNdXNpY1JoeXRobUxldmVsLnByb3RvIlEKEE11c2ljUmh5dGhtTGV2ZWwS",
            "FAoMdW5sb2NrX2xldmVsGA0gASgNEhUKDWlzX2Z1bGxfY29tYm8YCCABKAgS",
            "EAoIbGV2ZWxfaWQYBSABKA1CHqoCG0VnZ0xpbmsuRGFuaGVuZ1NlcnZlci5Q",
            "cm90b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.MusicRhythmLevel), global::EggLink.DanhengServer.Proto.MusicRhythmLevel.Parser, new[]{ "UnlockLevel", "IsFullCombo", "LevelId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public override int GetHashCode() {
      ...
      if (IsFullCombo != false) hash ^= IsFullCombo.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (IsFullCombo != false) {
        output.WriteRawTag(64);
        output.WriteBool(IsFullCombo);
      }
      if (UnlockLevel != 0) {
