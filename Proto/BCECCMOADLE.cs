...
namespace EggLink.DanhengServer.Proto {
  ...
  /// <summary>Holder for reflection information generated from BCECCMOADLE.proto</summary>
  public static partial class BCECCMOADLEReflection {

    #region Descriptor
    /// <summary>File descriptor for BCECCMOADLE.proto</summary>
    public static pbr::FileDescriptor Descriptor {
      get { return descriptor; }
    }
    private static pbr::FileDescriptor descriptor;

    static BCECCMOADLEReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.BCECCMOADLE), global::EggLink.DanhengServer.Proto.BCECCMOADLE.Parser, new[]{ "Uid", "Level", "Nickname", "LMNDOGAFOGC", "Platform", "FLFKCIHCENF", "KDCLOCAPBGE", "Version" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class BCECCMOADLE : pb::IMessage<BCECCMOADLE>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
    private static readonly pb::MessageParser<BCECCMOADLE> _parser = new pb::MessageParser<BCECCMOADLE>(() => new BCECCMOADLE());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pb::MessageParser<BCECCMOADLE> Parser { get { return _parser; } }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::EggLink.DanhengServer.Proto.BCECCMOADLEReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public BCECCMOADLE(BCECCMOADLE other) : this() {
      ...
      lMNDOGAFOGC_ = other.lMNDOGAFOGC_;
      platform_ = other.platform_;
      fLFKCIHCENF_ = other.fLFKCIHCENF_;
      kDCLOCAPBGE_ = other.kDCLOCAPBGE_;
    ...
    /// <summary>Field number for the "KDCLOCAPBGE" field.</summary>
    public const int KDCLOCAPBGEFieldNumber = 7;
    private string kDCLOCAPBGE_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string KDCLOCAPBGE {
      get { return kDCLOCAPBGE_; }
      set {
        kDCLOCAPBGE_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public override bool Equals(object other) {
      return Equals(other as BCECCMOADLE);
    }
    ...
    public bool Equals(BCECCMOADLE other) {
      ...
      if (LMNDOGAFOGC != other.LMNDOGAFOGC) return false;
      if (Platform != other.Platform) return false;
      if (FLFKCIHCENF != other.FLFKCIHCENF) return false;
      if (KDCLOCAPBGE != other.KDCLOCAPBGE) return false;
    ...
    public override int GetHashCode() {
      ...
      if (LMNDOGAFOGC != 0) hash ^= LMNDOGAFOGC.GetHashCode();
      ...
      if (KDCLOCAPBGE.Length != 0) hash ^= KDCLOCAPBGE.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (LMNDOGAFOGC != 0) {
        ...
        output.WriteUInt32(LMNDOGAFOGC);
      }
      ...
      if (KDCLOCAPBGE.Length != 0) {
        output.WriteRawTag(58);
        output.WriteString(KDCLOCAPBGE);
      }
      if (Version != 0UL) {
    ...
    public int CalculateSize() {
      ...
      if (LMNDOGAFOGC != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(LMNDOGAFOGC);
      }
      if (Platform != global::EggLink.DanhengServer.Proto.PlatformType.Editor) {
      ...
      if (KDCLOCAPBGE.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(KDCLOCAPBGE);
      }
      if (Version != 0UL) {
    ...
    public void MergeFrom(BCECCMOADLE other) {
      ...
      if (other.LMNDOGAFOGC != 0) {
        LMNDOGAFOGC = other.LMNDOGAFOGC;
      }
