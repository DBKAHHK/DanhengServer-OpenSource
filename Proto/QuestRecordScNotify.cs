...
namespace EggLink.DanhengServer.Proto {
    ...
    static QuestRecordScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byI4ChNRdWVzdFJlY29yZFNjTm90aWZ5EiEKC09LSU9NSkFKR0RGGA0gASgL",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.QuestRecordScNotify), global::EggLink.DanhengServer.Proto.QuestRecordScNotify.Parser, new[]{ "OKIOMJAJGDF" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public QuestRecordScNotify(QuestRecordScNotify other) : this() {
      oKIOMJAJGDF_ = other.oKIOMJAJGDF_ != null ? other.oKIOMJAJGDF_.Clone() : null;
    ...
    /// <summary>Field number for the "OKIOMJAJGDF" field.</summary>
    public const int OKIOMJAJGDFFieldNumber = 13;
    private global::EggLink.DanhengServer.Proto.QuestRecord oKIOMJAJGDF_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.QuestRecord OKIOMJAJGDF {
      get { return oKIOMJAJGDF_; }
      set {
        oKIOMJAJGDF_ = value;
      }
    }
    ...
    public bool Equals(QuestRecordScNotify other) {
      ...
      if (!object.Equals(OKIOMJAJGDF, other.OKIOMJAJGDF)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (oKIOMJAJGDF_ != null) hash ^= OKIOMJAJGDF.GetHashCode();
    ...
    #else
      if (oKIOMJAJGDF_ != null) {
        output.WriteRawTag(106);
        output.WriteMessage(OKIOMJAJGDF);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (oKIOMJAJGDF_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(OKIOMJAJGDF);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(QuestRecordScNotify other) {
      ...
      if (other.oKIOMJAJGDF_ != null) {
        if (oKIOMJAJGDF_ == null) {
          OKIOMJAJGDF = new global::EggLink.DanhengServer.Proto.QuestRecord();
        }
        OKIOMJAJGDF.MergeFrom(other.OKIOMJAJGDF);
      }
