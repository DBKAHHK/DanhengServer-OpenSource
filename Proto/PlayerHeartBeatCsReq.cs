...
namespace EggLink.DanhengServer.Proto {
    ...
    static PlayerHeartBeatCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YS5wcm90byJrChRQbGF5ZXJIZWFydEJlYXRDc1JlcRImCgtIQ1BLUFBGR0VN",
            "QRgIIAEoCzIRLkNsaWVudFVwbG9hZERhdGESEwoLQ0lBSE5DRUJKR0UYBSAB",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.PlayerHeartBeatCsReq), global::EggLink.DanhengServer.Proto.PlayerHeartBeatCsReq.Parser, new[]{ "HCPKPPFGEMA", "CIAHNCEBJGE", "ClientTimeMs" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public PlayerHeartBeatCsReq(PlayerHeartBeatCsReq other) : this() {
      hCPKPPFGEMA_ = other.hCPKPPFGEMA_ != null ? other.hCPKPPFGEMA_.Clone() : null;
    ...
    public const int HCPKPPFGEMAFieldNumber = 8;
    private global::EggLink.DanhengServer.Proto.ClientUploadData hCPKPPFGEMA_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.ClientUploadData HCPKPPFGEMA {
    ...
    public const int CIAHNCEBJGEFieldNumber = 5;
    ...
    public bool Equals(PlayerHeartBeatCsReq other) {
      ...
      if (!object.Equals(HCPKPPFGEMA, other.HCPKPPFGEMA)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (hCPKPPFGEMA_ != null) hash ^= HCPKPPFGEMA.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (hCPKPPFGEMA_ != null) {
        output.WriteRawTag(66);
        output.WriteMessage(HCPKPPFGEMA);
      }
      if (ClientTimeMs != 0UL) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (hCPKPPFGEMA_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(HCPKPPFGEMA);
      }
      if (CIAHNCEBJGE != 0) {
    ...
    public void MergeFrom(PlayerHeartBeatCsReq other) {
      ...
      if (other.hCPKPPFGEMA_ != null) {
        if (hCPKPPFGEMA_ == null) {
          HCPKPPFGEMA = new global::EggLink.DanhengServer.Proto.ClientUploadData();
        }
        HCPKPPFGEMA.MergeFrom(other.HCPKPPFGEMA);
      }
