...
namespace EggLink.DanhengServer.Proto {
    ...
    static MonopolyLikeScRspReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bGlzdBgEIAEoCzIJLkl0ZW1MaXN0EhMKC0lDRkVFR0VJSU9CGAIgASgNQh6q",
            "AhtFZ2dMaW5rLkRhbmhlbmdTZXJ2ZXIuUHJvdG9iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.ItemListReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.MonopolyLikeScRsp), global::EggLink.DanhengServer.Proto.MonopolyLikeScRsp.Parser, new[]{ "Retcode", "RewardList", "ICFEEGEIIOB" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public MonopolyLikeScRsp(MonopolyLikeScRsp other) : this() {
      ...
      iCFEEGEIIOB_ = other.iCFEEGEIIOB_;
    ...
    /// <summary>Field number for the "ICFEEGEIIOB" field.</summary>
    public const int ICFEEGEIIOBFieldNumber = 2;
    private uint iCFEEGEIIOB_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint ICFEEGEIIOB {
      get { return iCFEEGEIIOB_; }
      set {
        iCFEEGEIIOB_ = value;
      }
    }
    ...
    public bool Equals(MonopolyLikeScRsp other) {
      ...
      if (ICFEEGEIIOB != other.ICFEEGEIIOB) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ICFEEGEIIOB != 0) hash ^= ICFEEGEIIOB.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ICFEEGEIIOB != 0) {
        ...
        output.WriteUInt32(ICFEEGEIIOB);
      }
      if (rewardList_ != null) {
    ...
    public int CalculateSize() {
      ...
      if (ICFEEGEIIOB != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(ICFEEGEIIOB);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(MonopolyLikeScRsp other) {
      ...
      if (other.ICFEEGEIIOB != 0) {
        ICFEEGEIIOB = other.ICFEEGEIIOB;
      }
