...
namespace EggLink.DanhengServer.Proto {
    ...
    static BattleOpReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ASgNEhMKC09ISkxMQ01OSk5IGAggASgJQh6qAhtFZ2dMaW5rLkRhbmhlbmdT",
            "ZXJ2ZXIuUHJvdG9iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.BattleOp), global::EggLink.DanhengServer.Proto.BattleOp.Parser, new[]{ "TurnCounter", "State", "ActionEntityId", "TargetEntityId", "OpType", "SkillIndex", "OperationCounter", "OHJLLCMNJNH" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public BattleOp(BattleOp other) : this() {
      ...
      oHJLLCMNJNH_ = other.oHJLLCMNJNH_;
    ...
    /// <summary>Field number for the "OHJLLCMNJNH" field.</summary>
    public const int OHJLLCMNJNHFieldNumber = 8;
    private string oHJLLCMNJNH_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string OHJLLCMNJNH {
      get { return oHJLLCMNJNH_; }
      set {
        oHJLLCMNJNH_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(BattleOp other) {
      ...
      if (OHJLLCMNJNH != other.OHJLLCMNJNH) return false;
    ...
    public override int GetHashCode() {
      ...
      if (OHJLLCMNJNH.Length != 0) hash ^= OHJLLCMNJNH.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (OHJLLCMNJNH.Length != 0) {
        output.WriteRawTag(66);
        output.WriteString(OHJLLCMNJNH);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (OHJLLCMNJNH.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(OHJLLCMNJNH);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(BattleOp other) {
      ...
      if (other.OHJLLCMNJNH.Length != 0) {
        OHJLLCMNJNH = other.OHJLLCMNJNH;
      }
