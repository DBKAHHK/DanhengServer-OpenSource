...
namespace EggLink.DanhengServer.Util.Security
{
    public class AES128
    {
        ...
        private static void ShiftRows(byte[] state)
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                state[i] = temp[Magic.ShiftRowsTable[i]];
            }
        }
        private static void ShiftRowsInv(byte[] state)
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                state[i] = temp[Magic.ShiftRowsTableInv[i]];
            }
        }
        ...
        private static void MixColInv(byte[] state, int offset)
        {
            ...
            state[offset + 1] = (byte)(Magic.LookupG14[a1] ^ Magic.LookupG9[a0] ^ Magic.LookupG13[a3] ^ Magic.LookupG11[a2]);
            state[offset + 2] = (byte)(Magic.LookupG14[a2] ^ Magic.LookupG9[a1] ^ Magic.LookupG13[a0] ^ Magic.LookupG11[a3]);
            state[offset + 3] = (byte)(Magic.LookupG14[a3] ^ Magic.LookupG9[a2] ^ Magic.LookupG13[a1] ^ Magic.LookupG11[a0]);
        }
